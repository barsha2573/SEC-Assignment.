...
<head>
  ...
  <title>English Literature Project</title>
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600&family=Poppins:wght@400;600&family=Roboto&display=swap" rel="stylesheet">
  <style>
    body {
      margin: 0;
      padding: 0;
      background: linear-gradient(to right, #f9f3ff, #e6fffa);
  ...
  <main>
    ...
    <div class="about-me">
      <div class="about-photo">
        <img src="bar.jpeg" alt="Barsha Das Photo" />
